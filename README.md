...
- **No dependencies** — vanilla JavaScript using the standard Web Speech API.
...
2. Create a new script in your manager and paste the contents of [`highlight-tts.js`](./highlight-tts.js) into it.
